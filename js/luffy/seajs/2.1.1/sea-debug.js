...
Module.prototype.load = function() {
  ...
  // Emit `load` event for plugins such as combo libs
...
Module.prototype.fetch = function(requestCache) {
  ...
  // Emit `fetch` event for plugins such as combo libs
  ...
  // Emit `request` event for plugins such as text libs
...
Module.resolve = function(id, refUri) {
  // Emit `resolve` event for plugins such as text libs
...
Module.define = function (id, deps, factory) {
  ...
  // Emit `define` event, used in nocache libs, seajs node version etc
  emit("define", meta)
