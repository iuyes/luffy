define("playman/pdialog/1.1.0/pdialog-debug", [ "$-debug", "arale/overlay/1.1.3/overlay-debug", "arale/position/1.0.1/position-debug", "arale/iframe-shim/1.0.2/iframe-shim-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "arale/overlay/1.1.3/mask-debug", "arale/templatable/0.9.1/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug", "./pdialog-debug.css", "./dialog-debug.handlebars" ], function(require, exports, module) {
...
define("playman/pdialog/1.1.0/pdialog-debug.css", [], function() {
    seajs.importStyle(".m-dialog{padding:0;background:#fff;border:9px solid rgba(0,0,0,.4);box-shadow:0 0 5px rgba(0,0,0,.6);border-radius:5px}.m-dialog-close{color:#999;cursor:pointer;font-size:20px;line-height:24px;font-weight:700;height:24px;width:24px;position:absolute;display:block;right:11px;text-align:center;text-decoration:none;top:11px;z-index:10;vertical-align:middle}.m-dialog-close:hover{text-decoration:none;color:#666;text-shadow:0 0 2px #aaa}.m-dialog-title{height:45px;font-size:16px;font-family:'΢���ź�','����',Arial;line-height:46px;border-bottom:1px solid #e1e1e1;color:#4d4d4d;text-indent:20px;background:-webkit-gradient(linear,left top,left bottom,from(#fcfcfc),to(#f9f9f9));background:-moz-linear-gradient(top,#fcfcfc,#f9f9f9);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#fcfcfc', endColorstr='#f9f9f9');background:-o-linear-gradient(top,#fcfcfc,#f9f9f9);background:linear-gradient(top,#fcfcfc,#f9f9f9)}.m-dialog-container{font-size:12px}.m-dialog-message{margin-bottom:15px}.m-dialog-operation{zoom:1}.m-dialog-confirm,.m-dialog-cancel{display:inline}.m-dialog-operation .m-dialog-confirm{margin-right:4px}.m-dialog-button-orange,.m-dialog-button-white{display:inline-block;*display:inline;*zoom:1;text-align:center;text-decoration:none;vertical-align:middle;cursor:pointer;font-size:12px;font-weight:700;border-radius:2px;padding:0 12px;line-height:23px;height:23px;*overflow:visible;background-image:none}a.m-dialog-button-orange:hover,a.m-dialog-button-white:hover{text-decoration:none}.m-dialog-button-orange{color:#fff;border:1px solid #d66500;background-color:#f57403}.m-dialog-button-orange:hover{background-color:#fb8318}.m-dialog-button-white{border:1px solid #afafaf;background-color:#f3f3f3;color:#777}.m-dialog-button-white:hover{border:1px solid #8e8e8e;background-color:#fcfbfb;color:#676d70}");
});

define("playman/pdialog/1.1.0/dialog-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
